...
const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 w-72 h-screen bg-white shadow-xl flex flex-col border-r border-slate-200 z-50">
      {/* Make it fixed with fixed, left-0, top-0, and z-50 */}
          ...
          {navItems.map((item) => (
            <li key={item.name}>
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-slate-700 hover:bg-teal-50 hover:text-teal-700 transition-all duration-200 group"
              >
      ...
      <div className="p-4 border-t border-slate-200 mt-auto">
        {/* Added mt-auto to push logout button to bottom */}
        <button
          onClick={logout}
